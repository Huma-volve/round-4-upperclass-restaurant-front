...
export default function ContactPage() {
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-[#050505] text-white font-chillax">
      {/* Left Side */}
      <div
        className=" flex flex-col justify-between items-center p-10 bg-cover bg-center h-auto md:h-screen md:sticky md:top-0"
      ...
      >
        ...
        <div className="text-center">
          ...
          <h1 className=" font-chillax text-[#fff] text-4xl sm:text-5xl xl:text-6xl 2xl:text-[80px] font-bold">
            Get in Touch
          </h1>
        </div>
        <div className="">
        ...
        <form className="flex flex-col gap-12">
          <div className="flex flex-col gap-4">
            ...
            <Input
              ...
              className="bg-black border placeholder-white border-gray-600 h-[60px] rounded-[10px]"
            />
          </div>
          <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Textarea
              ...
              className="bg-black border placeholder-white border-gray-600 h-[120px] rounded-[10px]"
            />
          </div>
        </form>
